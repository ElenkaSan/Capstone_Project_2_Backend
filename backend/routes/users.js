...
router.put("/:username/flights/:id", ensureCorrectUserOrAdmin, async function (req, res, next) {
  try {
...
router.delete("/:username/flights/:id", ensureCorrectUserOrAdmin, async function (req, res, next) {
  try {
    const flightId = req.params.id;
...
// // HOTEL
router.put("/:username/hotels/:hotelId", ensureCorrectUserOrAdmin, async function (req, res, next) {
  try {
...
router.delete("/:username/hotels/:hotelId", ensureCorrectUserOrAdmin, async function (req, res, next) {
  try {
    const hotelId = req.params.hotelId;
